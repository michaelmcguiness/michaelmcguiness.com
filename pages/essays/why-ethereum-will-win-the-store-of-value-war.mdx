---
title: "Why Ethereum Will Win the Store of Value War"
...
image: "/static/images/why-ethereum-will-win-the-store-of-value-war/banner.png"
...
![Ethereum Validating Issuance](/static/images/why-ethereum-will-win-the-store-of-value-war/validating-issuance.png)
...
![Ethereum's Historical and Projected Issuance Rate](/static/images/why-ethereum-will-win-the-store-of-value-war/projected-issuance.png)
...
![Scenario: Cumulative Fees Burned by EIP 1559](/static/images/why-ethereum-will-win-the-store-of-value-war/fees-burned.png)
...
![Ethereum is Ultrasound Money](/static/images/why-ethereum-will-win-the-store-of-value-war/banner.png)
...
![Stock-to-Flow Table](/static/images/why-ethereum-will-win-the-store-of-value-war/s2f-table.png)
...
![Stock-to-Flow Projection](/static/images/why-ethereum-will-win-the-store-of-value-war/s2f-projection.png)
...
![Bitcoin Monetary Inflation](/static/images/why-ethereum-will-win-the-store-of-value-war/btc-inflation.png)
...
![Dan Held Fee Calculator Projections](/static/images/why-ethereum-will-win-the-store-of-value-war/held-projections.png)
...
![USD tokens on Ethereum](/static/images/why-ethereum-will-win-the-store-of-value-war/stablecoins.png)
...
![NFT Volume](/static/images/why-ethereum-will-win-the-store-of-value-war/nft-volume.png)
...
![A Shift in Demand](/static/images/why-ethereum-will-win-the-store-of-value-war/demand-shift.png)
...
Two years before Amazon, there was Book Stacks Unlimited. Four years before Google, Yahoo! made the original global search engine. Before Facebook, MySpace dominated social media. The list goes on.

There are countless examples throughout tech history of first movers generating interest in a concept or product, and then late movers swooping in and improving upon what already exists. I don't really have a great mitigant for how Ethereum will be immune from this. The best argument I've heard is that Ethereum is a protocol, and the history of protocols (e.g. http, stmp, etc.) is much different from the protocols of products. Once a protocol is established, it's nearly impossible to replace. But if this was true, how would Ethereum be able to beat Bitcoin at its own game?

The only way that I was able to get comfortable with this risk was to acknowledge that I'll simply have to monitor the space and adapt to this risk on a continuous basis. In essence, I'll be putting all of my eggs in one basket and watching that basket very closely.

**Monetary Policy Stability**

Bitcoin is the must unchangeable crypto-system that will likely ever exist. Bitcoiners believe this is where the real value of Bitcoin lies. It's a credibly neutral system based on code, not people, that you can depend on for decades.
