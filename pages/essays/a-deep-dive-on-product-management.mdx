...
![A Deep Dive on Product Management](/static/images/a-deep-dive-on-product-management/banner.png)[Chart Source: Sachin Rekhi](https://www.sachinrekhi.com/top-10-deliverables-of-product-managers)

## What Exactly is Product Management?

Product management is a critical role at technology firms. Yet, a lot of people don't really know what it means. Most books and articles define it as the intersection of business, technology, and user experience. Yet, this doesn't really capture the various responsibilities of and skills needed by product managers.

One of my favorite definitions of product management comes from a [talk](https://www.sachinrekhi.com/video-the-art-of-product-management) that Sachin Rekhi gave at Wharton back in 2016. His opening slide contained the following definition:

> Product managers drive the **vision**, **strategy**, **design**, and **execution** of their product.

I like this definition because it is much more actionable in terms of how product managers should think about their role and where they should be focusing their time. In fact this essay is mostly an amalgamation of ideas pulled from Sachin's essays that analyze product management under this framework. Normally I would try to put the main concepts into my own words, but I had a difficult time improving on Sachin's ideas. Hopefully I added some value by synthesizing and summarizing the ideas in a single document. Please see the [Sources](#sources) section at the bottom for links to the individual essays.

## The Four Dimensions of Product Management

### Vision

A compelling vision articulates how the world will be a better place if you succeed. And to properly formulate this vision, you need to have a deep understanding of the target audience, the existing solutions and competitors in the market, and a compelling thesis for why your solution provides a 10x improvement over the existing alternatives. Simply summarizing the vision in a short and pithy vision statement will not suffice.

**Vision Narrative**

Product managers must clearly formulate and then evangelize the audience you are targeting, the distinct problem you are solving, and your unique solution by which you will win the market. And the best format for doing this is a customer-centric **vision narrative**. Jeff Bezos actually popularized this idea by requiring his executives to write a 6-page narratively-structured document before discussing strategic initiatives. The key idea underlying this requirement is that there is almost no way to write such a document without clearly thinking through all aspects of a problem. Bezos actually does this himself every year in his annual shareholder letters:
...
A vision narrative doesn't have to be super long. Just one or two pages should allow you to provide more than enough context: the state of the world today, the value your product currently delivers in the world, how achieving your ultimate vision will materially change today's state of affairs, and a set of steps to ultimately get there. One of the best examples of a compelling vision narrative is [The Tesla Master Plan by Elon Musk](https://www.tesla.com/blog/secret-tesla-motors-master-plan-just-between-you-and-me). [Google](http://infolab.stanford.edu/pub/papers/google.pdf) and [Slack](https://medium.com/@stewart/we-dont-sell-saddles-here-4c59524d650d#.s97x9xpzr) also serve as terrific examples of compelling vision narratives.

**Product Walkthrough**

To supplement the written narrative, we should also proveide a visual representation of what the future could look like if we are successful. This most often takes the form of a click-through prototype or concept mockups that show what a future version of the product could look like. These are most often high-fidelity that will never actually be implemented, but they extremely useful to illustrate your company's ambitions to various stakeholders (e.g. investors, employees, leadership, customers, etc.).

Elon Musk is probably the king of these **product vision walkthroughs**. For example, [this video](https://www.youtube.com/watch?v=0qo78R_yYFA) from 2016 showcases the vision for SpaceX's Interplanetary Transport System which aims to bring the first manned crew to Mars. While this representation isn't intended to be implemented anytime soon, it showcases the kind of inspirational feeling a successful product walkthrough leaves your audience with.

However, simply writing a strong vision is not enough. The product leader must be constantly evangelize that vision to his or her team. Before you can convince your team of your vision, you need to start by building strong conviction within yourself thaty our vision will win in the marketplace. Without that, it will be impossible to convince your team. Once you have that, it becomes important to craft your vision into a compelling narrative that your team can get behind. And then you need to focus on delivering this message continuously to your teaam so they never lose sight of it. A good litmus test is that when you ask a team member what the product is all about and where the team is going, the should be able to repeat your vision. If they can, then you've done a good job of articulating the vision, inspiring the team, and letting it sink in.

### Strategy

A compelling strategy delineates exactly how you will dominate your market. The major difference between strategy and vision is that your vision should be stable. Strategy, on the other hand, needs to be constantly iterated on and refined.

When you initially start working on a product, you have a set of hypotheses for how you'll dominate your market. But they really are just hypotheses, and as you get customer and market feedback, you'll refine them. And even when you think you've figuraed it all out, market dynamics inevitably change (e.g. new competitors, recessions, etc.).

**Product/Market Fit Hypotheses**

When it comes to strategy, you don't need a business plan. Business plans give you false precision and the false belief that you have everything figured out. However, as soon as you start executing, you will quickly find out that many parts of it don't work. Instead, articulate your strategy with a 2-3 page summary that captures each of your critical **product/market fit hypotheses**. These are just your best guesses on what is going to work, and you chould constantly refine them. Sachin Rehki finds that every business requires at least these 8 product/market fit hypotheses that make up their product strategy, but your specific business may have more:

1. **Target Audience.** Who is the ideal customer for your product. Don't think about the broadest possible definition of TAM. Instead think of the bullseye of your very best potential customers.
...
1. **Monetization Strategy.** What will be your primary and secondary monetization mechnaisms? What is your customer's willingness-to-pay for your offering?
...
When everyone on the team feels like they understands what the most important priorities are, understands exactly what success looks like, and understands who is responsible for each part, you get incredible leverage from each and every team member that allows you to accomplish way more than a team without this shared context.

OKRs are also important for communicating your team's priorities, progress, and milestones to senior leadership and the executive team. Since senior leadership is ultimately responsible for the resources allocated to your project, it's important to keep them abreast and aware of where you stand and thus communicating OKR progress regularly is one ofthe most effective ways of doing so.
