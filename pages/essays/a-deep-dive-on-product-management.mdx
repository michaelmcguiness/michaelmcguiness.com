...
Most descriptions of the product management role tend to either be overly vague (you are responsible for the product) or overly specific (you write product specifications). Neither is particularly effective in helping people become great product managers. In this essay, I've tried to coalesce the best ideas from the field's leading thinkers into one comprehensive guide.

In a sentence, product managers help companies define, build, and launch new products. [Marty Cagan](https://twitter.com/cagan?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor) argues that product managers are ultimately responsible for ensuring that what gets built is both **valuable** and **viable**. This makes strong product managers force multipliers that can help cross-functional teams of great engineers and designers do their best work. Bad product managers, on the other hand, can lead to the wrong product being built.
...
These four skills provide a critical foundation for product managers to excel in their daily responsibilities. But what exactly are these responsibilities? Well, my favorite way to think of the specific responsibilities of a product manager comes from a [talk](https://www.sachinrekhi.com/video-the-art-of-product-management) that [Sachin Rekhi](https://www.sachinrekhi.com/) gave at Wharton back in 2016. He kicked off the talk with the following text on his opening slide:

> Product managers drive the **vision**, **strategy**, **design**, and **execution** of their product.

Below is an amalgamation of ideas pulled from Sachin's essays (along with the ideas of Cagan, [Adam Nash](https://adamnash.blog/), and [Bubba Murarka](https://twitter.com/bubba)) that analyze the specifics of product management across these four dimensions. A lot of it is copy-and-pasted or transcribed from talks, but hopefully I added some value by synthesizing the ideas in a single document. Please see the [Sources](#sources) section at the bottom for links to the individual resources.
