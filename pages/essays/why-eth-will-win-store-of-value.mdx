...
There are countless examples throughout tech history of first movers generating interest in a concept or product, and then late movers swooping in and improving upon what already exists. The best protection against this likely comes from the fact that the Ethereum community and protocol is innovation-friendly. "Bitcoin will absorb all innovation" was a meme which never came true. Ethereum actually has a shot at it, to a large exctent because they have "feature escape velocity" at the EVM level.

However, I do acknowledge that I'll have to monitor the new developments in the space and adapt to this risk on a continuous basis. In essence, I'll be putting all of my eggs in one basket and watching that basket very closely.
